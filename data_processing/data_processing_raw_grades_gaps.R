...
asu_gap <- read.csv("ASU_mean_grade_gpa_differences_by_offering_2023-04-24.csv")
iu_gap <- read.csv("IUB_mean_grade_gpa_differences_by_offering_2023-04-25.csv")
pur_gap <-read.csv("Purdue_mean_grade_gpa_differences_by_offering_2023-04-26.csv")
um_gap<- read.csv("UMich_mean_grade_gpa_differences_by_offering_2023-04-12.csv")
ucd_gap <- read.csv("UCD_mean_grade_gpa_differences_by_offering_2023-09-19.csv")

#by ethniccode
asu_eth <- read.csv("ASU_mean_grade_gpa_diff_offering_ethniccode_2023-04-24.csv")
iu_eth <- read.csv("IUB_mean_grade_gpa_diff_offering_ethniccode_2023-04-25.csv")
pur_eth <-read.csv("Purdue_mean_grade_gpa_diff_offering_ethniccode_2023-04-26.csv")
um_eth<- read.csv("UMich_mean_grade_gpa_diff_offering_ethniccode_2023-04-12.csv") 
ucd_eth <- read.csv("UCD_mean_grade_gpa_diff_offering_ethniccode_2023-09-19.csv")
